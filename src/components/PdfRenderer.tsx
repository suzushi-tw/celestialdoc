    ...
    <div className='w-full bg-white rounded-md shadow flex flex-col items-center'>
      <div className='h-14 w-full border-b border-zinc-200 flex items-center justify-between px-2'>
        ...
        {/* <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="airplane-mode">GPT4</Label>
        </div> */}
          ...
          {/* <DropdownMenu>
            ...
            <DropdownMenuContent>
              <form action={async (FormData) => {
                ...
                await handleLanguageChange(FormData)
                // Update the state variable with the user input
                setCurrentLanguage(FormData.get("language")?.toString() ?? "none")
              }}>
                <Input
                  type='text'
                  name='language'
